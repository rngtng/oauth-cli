oauthc - a simple CLI client to test your oauth API easily
---------------------------------------------------------------------------
...
= EXAMPLES
oauthc was originaly developed to test the Qype API. So run these exmaples agains it:
...
problem with oauth client provided with the gem is the lack of post request with body content as
well as easy usage with repl to have proper CLI options
